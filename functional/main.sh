...
execc app "oph_apply query=oph_reduce2(measure,'OPH_ARG_MAX',10,8,45);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_reduce2(measure,'OPH_ARG_MIN',10,4,90);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
