...
execc app "oph_apply query=oph_append(measure,measure);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_append(measure,measure,measure);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
...
execc app "oph_apply query=oph_interlace(measure,measure);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_interlace(measure,measure,measure);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
