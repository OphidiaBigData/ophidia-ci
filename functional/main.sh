...
execc app "oph_apply query=oph_append('oph_float|oph_float','oph_float,oph_float',measure,measure);cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_append('oph_float|oph_float|oph_float','oph_float,oph_float,oph_float',measure,measure,measure);cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
...
execc app "oph_apply query=oph_interlace('oph_float|oph_float','oph_float,oph_float',measure,measure);cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_interlace('oph_float|oph_float|oph_float','oph_float,oph_float,oph_float',measure,measure,measure);cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_moving_avg(measure);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
...
execc app "oph_apply query=oph_reduce2(measure,'OPH_ARG_MAX',80,8,45);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
execc app "oph_apply query=oph_reduce2(measure,'OPH_ARG_MIN',40,4,90);measure_type=auto;cube=[measure=jenkins;level=0];ncores=$core;cwd=$cwd;"
