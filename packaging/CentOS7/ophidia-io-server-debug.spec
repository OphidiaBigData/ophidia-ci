Name:         ophidia-io-server-debug
Version:      **VERSION**
Release:      **RELEASE**%{?dist}
Summary:      Ophidia IO Server (debug mode)
...
%description
Ophidia native IO server module to perform I/O and queries on multidimensional data. Debug mode is enabled.
